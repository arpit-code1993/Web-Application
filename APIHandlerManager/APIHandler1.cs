  ...
  public class APIHandler1
  {
    ...
    public APIHandler1()
    {
      ...
      httpClient.DefaultRequestHeaders.Accept.Add(
        ...
        {
            string API_PATH = BASE_URL + "?search=outcome.medical_status:%22Died%22+AND+animal.species:%22Dog%22&limit=100";
            string dogsData = "";

            RootObject data2 = null;
            ...
            try
            {
                ...
                {
                    dogsData = response.Content.ReadAsStringAsync().GetAwaiter().GetResult();
                }

                if (!dogsData.Equals(""))
                {
                    // JsonConvert is part of the NewtonSoft.Json Nuget package
                    data2 = JsonConvert.DeserializeObject<RootObject>(dogsData);
                }
            }
            catch (Exception e)
            {
