...
namespace Assignment_4.Models
{
    ...
    public class FrequencyOfAdministration
    {
    ...
    public class Drug
    {
        ...
        public FrequencyOfAdministration frequency_of_administration { get; set; }
    ...
    public class Result
    {
        ...
        public HealthAssessmentPriorToExposure health_assessment_prior_to_exposure { get; set; }
